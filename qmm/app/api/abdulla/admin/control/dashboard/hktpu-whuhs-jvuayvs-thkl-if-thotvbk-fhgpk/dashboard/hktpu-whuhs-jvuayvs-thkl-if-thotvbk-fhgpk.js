...
export default function CodeLoginPage() {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    // TODO: call your API here (e.g. POST /api/auth/code)
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 placeholder:text-slate-400 outline-none ring-0 transition focus:border-slate-300 focus:bg-white focus:ring-4 focus:ring-indigo-100"
                    />
                  </div>
                </div>
